...
APP_ID=os.environ.get("APP_ID", "hostwatch")
APP_TOKEN=os.environ.get("APP_TOKEN", "e23a2b06-b70d-4de2-99fe-52968dd8aef2")
BK_PAAS_HOST=os.environ.get("BK_PAAS_HOST", "http://paas.bktest.com/")
